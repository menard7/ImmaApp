    ...
    <div class="row">
      <div class="col-lg-8 shadow p-3">
        <div class="container">
          ...
          <form action="verification_demande.php" method="Post" enctype="multipart/form-data">
            <div class="row">
              <div class="col-md-6">
            ...
            <button type="submit" class="btn btn-secondary w-25 text-uppercase" href="page_suivant
                .php" style="float: right;">Valider </a>
                <?php
