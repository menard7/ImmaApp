...
<head>
	...
	<title>Statut demande - ImmaApp</title>
...
<br>
      <div class="text-center p-5"><h4><b>Vérifiez le statut de votre demande</b></h3></div>
<br>
</div>
            ...
            <form action="#!">
                    ...
                    <div class="form-group">
                        <input type="email" class="form-control" id="mail" placeholder="adresse email">
                    </div>
